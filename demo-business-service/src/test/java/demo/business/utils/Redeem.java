...
public class Redeem {
    ...
    final static String password = "meituanwaimai";
    ...
    public static void main( String[] args ) throws Exception
    {
        ShowTime();
        System.out.println("=======================");
        create((byte)2,10,12,password);

        VerifyCode("kcs2e57me4na");
    }
    ...
    public static byte[] create(byte groupid,int codecount,int codelength,String password) {
        ...
        //随机码对时间和id同时做异或处理
        //类型1，id4，随机码n,校验码1
        int randcount = fullcodelength - 6;//随机码有多少位
